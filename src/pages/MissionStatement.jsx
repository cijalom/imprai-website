        ...
        <div>
            ...
            <div className = "p-4 bg-stone-200 flex flex-col justify center overflow-hidden">
                <div className = "p-5 flex flex-row justify-center items-center gap-12">
                    ...
                    <img src = {mission_statement_1} className = "object-cover w-200 h-120 fade-in delay-2 text-black" alt = "image placeholder"/>
                </div>
            </div>
            <div className = "p-4 bg-stone-300 flex flex-col justify center overflow-hidden">
                <div className = "p-5 flex flex-row justify-center items-center gap-12">
                    <img src = {mission_statement_2} className = "object-cover w-200 h-120 fade-in delay-2 text-black" alt = "image placeholder"/>
                    <div className = "fade-in h-120 w-px bg-black"></div>
                    <div className = "flex flex-col justify-start items-start gap-2 w-1/3">
            ...
            <div className = "p-4 bg-stone-200 flex flex-col justify center overflow-hidden">
                <div className = "p-5 flex flex-row justify-center items-center gap-12">
                    ...
                    <div className = "fade-in h-120 w-px bg-black"></div>
                    <img src = {mission_statement_3} className = "object-cover object-center w-200 h-120 fade-in delay-2 text-black" alt = "image placeholder"/>
                </div>
            </div>
            <Footer/>
        </div>
